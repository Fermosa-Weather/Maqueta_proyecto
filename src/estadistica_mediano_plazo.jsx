...
function GeneracionEstadistica() {
  ...
  return (
    <div className="contenedor">
      ...
      <h1>Estadística de datos futuros a mediano plazo de (5 a 8 dias)</h1>
      <Helmet>
      ...
      <div className="contenedor_estadistica">
        ...
        <div className="grafico_figura">
          <img src="../src/assets/Estadistica/precipatacion.jpg" alt="Map" />
        </div>
        <div className="grafico_figura">
          <img src="../src/assets/Estadistica/estadistica_aumento.jpg" alt="Map" />
        </div>
        <div className="grafico_figura">
          <img src="../src/assets/Estadistica/tiempo_real_arena.jpg" alt="Map" />
        </div>
      </div>
